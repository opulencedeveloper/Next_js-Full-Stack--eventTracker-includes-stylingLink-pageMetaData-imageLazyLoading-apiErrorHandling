  ...
  if (
    ...
    return (
      <>
        {pageHeadData}
        <ErrorAlert>
          <p>Invalid filter. Please adjust your values! in the url</p>
        </ErrorAlert>
...
//   //if someone enters 'abc' or any string that cannot be converted to a number to the url, it is checked here
//   if (
//     isNaN(numYear) ||
//     isNaN(numMonth) ||
//     numYear > 2030 ||
